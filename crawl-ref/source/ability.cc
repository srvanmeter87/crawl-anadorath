...
static const ability_def Ability_List[] =
{
    ...
    { ABIL_FLY, "Fly",
      3, 0, 0, {fail_basis::xl, 42, 3}, abflag::none },
    { ABIL_STOP_FLYING, "Stop Flying",
      0, 0, 0, {}, abflag::none },
    ...
    { ABIL_KIKU_GIFT_NECRONOMICON, "Receive Necronomicon",
      0, 0, 0, {fail_basis::invo}, abflag::none },
    { ABIL_KIKU_BLESS_WEAPON, "Brand Weapon With Pain",
      0, 0, 0, {fail_basis::invo}, abflag::pain },
    ...
    { ABIL_MAKHLEB_MAJOR_DESTRUCTION, "Major Destruction",
      0, scaling_cost::fixed(6), generic_cost::range(0, 1), {fail_basis::invo, 60, 4, 25}, abflag::none },
    { ABIL_MAKHLEB_GREATER_SERVANT_OF_MAKHLEB, "Greater Servant of Makhleb",
      0, scaling_cost::fixed(10), 5, {fail_basis::invo, 90, 2, 5}, abflag::hostile },
    ...
    { ABIL_TROG_BROTHERS_IN_ARMS, "Brothers in Arms",
      0, 0, generic_cost::range(5, 6), {fail_basis::invo, piety_breakpoint(5), 0, 1}, abflag::none },

    // Elyvilon
    { ABIL_ELYVILON_LIFESAVING, "Divine Protection",
      0, 0, 0, {fail_basis::invo}, abflag::piety },
    { ABIL_ELYVILON_LESSER_HEALING, "Lesser Healing",
      1, 0, generic_cost::range(0, 1), {fail_basis::invo, 30, 6, 20}, abflag::none },
    ...
    { ABIL_LUGONU_BANISH, "Banish",
      4, 0, generic_cost::range(3, 4), {fail_basis::invo, 85, 7, 20}, abflag::none },
    { ABIL_LUGONU_CORRUPT, "Corrupt",
      7, scaling_cost::fixed(5), 10, {fail_basis::invo, 70, 4, 25}, abflag::none },
    { ABIL_LUGONU_ABYSS_ENTER, "Enter the Abyss",
      10, 0, 28, {fail_basis::invo, 80, 4, 25}, abflag::pain },
    ...
    { ABIL_RU_DRAW_OUT_POWER, "Draw Out Power",
      0, 0, 0, {fail_basis::invo}, abflag::exhaustion|abflag::skill_drain|abflag::conf_ok },
    ...
    { ABIL_PAKELLAS_DEVICE_SURGE, "Device Surge",
      0, 0, generic_cost::fixed(1), {fail_basis::invo, 40, 5, 20}, abflag::variable_mp | abflag::instant },
#endif
