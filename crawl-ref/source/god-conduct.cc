...
static const char *conducts[] =
    {
        ...
        "Ice", "Kill Icy", "Earth", "Kill Earthy",
        "Air", "Kill Airy", "Antimagic"
    };
...
static peeve_map divine_peeves[] =
{
    ...
    // GOD_ANADORATH,
        {
            { DID_ANTIMAGIC, {
                "you restrain magical energy", true,
                1, 1, " reluctantly forgives your accidental restraint of magic, just this once.",
                " does not tolerate your restraining of magical energy!"
            } },
            { DID_BANISH, {
                "you banish creatures to the Abyss", true,
                1, 1, " reluctantly forgives your accidental banishing, just this once.",
                " does not appreciate your cowardice in banishing!"
            } },
            { DID_HOLY, {
                "you use holy magic or items", true,
            ...
            { DID_KILL_AIRY, {
                "you kill airy beings", false,
                1, 1, " forgives your accidental killing of a being of air, just this once.",
                " is not amused by your slaughtering of airy beings."
            } },
            { DID_KILL_EARTHY, {
                "you kill earthen beings", false,
                1, 1, " forgives your accidental killing of a being of earth, just this once.",
                " is not amused by your slaughtering of earthen beings."
            } },
            { DID_KILL_FIERY, {
                "you kill fiery beings", false,
                1, 1, " forgives your accidental killing of a being of fire, just this once.",
                " is not amused by your slaughtering of fiery beings."
            } },
            { DID_KILL_ICY, {
                "you kill icy beings", false,
...
/*  Will this god definitely be upset if you cast this spell?
    ...
    @returns true if you will definitely
                  lose piety/get penance/be excommunicated */
