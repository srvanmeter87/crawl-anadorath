...
// also a dummy, and also rude to say so
{
    MONS_PYROLITH, 'H', MAGENTA, "pyrolith",
    M_SPEAKS | M_NO_POLY_TO,
    MR_RES_ACID | MR_RES_FIRE | MR_RES_PETRIFY | MR_RES_POISON
                | MR_RES_ROTTING | MR_VUL_COLD | MR_VUL_WATER,
    15, MONS_PYROLITH, MONS_PYROLITH, MH_NONLIVING, 12,
    ...
    {TILEP_BASE_PYROLITH}, TILE_CORPSE_FIRE_GIANT
},
