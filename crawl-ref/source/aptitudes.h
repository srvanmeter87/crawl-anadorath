...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_PYROLITH,        SK_SHORT_BLADES,   UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_LONG_BLADES,      2),
    APT(SP_PYROLITH,        SK_AXES,            -3),
    APT(SP_PYROLITH,        SK_MACES_FLAILS,    -2),
    APT(SP_PYROLITH,        SK_POLEARMS,         2),
    APT(SP_PYROLITH,        SK_STAVES,           3),
    APT(SP_PYROLITH,        SK_SLINGS,         UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_BOWS,           UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_CROSSBOWS,        2),
    APT(SP_PYROLITH,        SK_THROWING,       UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_ARMOUR,           4),
    APT(SP_PYROLITH,        SK_DODGING,        UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_STEALTH,        UNUSABLE_SKILL),
#if TAG_MAJOR_VERSION == 34
    APT(SP_PYROLITH,        SK_STABBING,       UNUSABLE_SKILL),
#endif
    APT(SP_PYROLITH,        SK_SHIELDS,          5),
#if TAG_MAJOR_VERSION == 34
    APT(SP_PYROLITH,        SK_TRAPS,          UNUSABLE_SKILL),
#endif
    APT(SP_PYROLITH,        SK_UNARMED_COMBAT,   3),
    APT(SP_PYROLITH,        SK_SPELLCASTING,     2),
    APT(SP_PYROLITH,        SK_CONJURATIONS,     3),
    APT(SP_PYROLITH,        SK_HEXES,           -1),
    APT(SP_PYROLITH,        SK_CHARMS,          -1),
    APT(SP_PYROLITH,        SK_SUMMONINGS,      -1),
    APT(SP_PYROLITH,        SK_NECROMANCY,      -1),
    APT(SP_PYROLITH,        SK_TRANSLOCATIONS, UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_TRANSMUTATIONS, UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_FIRE_MAGIC,       5),
    APT(SP_PYROLITH,        SK_ICE_MAGIC,      UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_AIR_MAGIC,      UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_EARTH_MAGIC,      5),
    APT(SP_PYROLITH,        SK_POISON_MAGIC,   UNUSABLE_SKILL),
    APT(SP_PYROLITH,        SK_INVOCATIONS,      3),
    APT(SP_PYROLITH,        SK_EVOCATIONS,      -1),
