...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_PYROLITH
    APT(SP_PYROLITH,        SK_FIGHTING,         1),
    APT(SP_PYROLITH,        SK_SHORT_BLADES,    -5),
    APT(SP_PYROLITH,        SK_LONG_BLADES,      2),
    APT(SP_PYROLITH,        SK_AXES,             0),
    APT(SP_PYROLITH,        SK_MACES_FLAILS,     0),
    APT(SP_PYROLITH,        SK_POLEARMS,         2),
    APT(SP_PYROLITH,        SK_STAVES,           2),
    APT(SP_PYROLITH,        SK_SLINGS,          -5),
    APT(SP_PYROLITH,        SK_BOWS,            -5),
    APT(SP_PYROLITH,        SK_CROSSBOWS,        0),
    APT(SP_PYROLITH,        SK_THROWING,        -5),
    ...
    APT(SP_PYROLITH,        SK_INVOCATIONS,      2),
    APT(SP_PYROLITH,        SK_EVOCATIONS,       0),
