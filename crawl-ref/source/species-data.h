...
{ SP_DEEP_ELF, {
    ...
    {},
    {},
    { JOB_WIZARD, JOB_CONJURER, JOB_SUMMONER, JOB_NECROMANCER, JOB_PRIMALIST,
...
{ SP_DEMIGOD, {
    ...
    {},
    {},
    { JOB_TRANSMUTER, JOB_CONJURER, JOB_FIRE_ELEMENTALIST,
...
{ SP_BASE_DRACONIAN, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_TRANSMUTER, JOB_CONJURER, JOB_PRIMALIST,
      JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST,
      JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
      SK_BOWS, SK_CROSSBOWS, SK_SLINGS },
...
{ SP_DEMONSPAWN, {
    ...
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_ABYSSAL_KNIGHT, JOB_WIZARD,
      JOB_NECROMANCER, JOB_PRIMALIST, JOB_FIRE_ELEMENTALIST,
...
{ SP_FELID, {
    ...
    { JOB_BERSERKER, JOB_ENCHANTER, JOB_PRIMALIST, JOB_TRANSMUTER,
      JOB_ICE_ELEMENTALIST, JOB_CONJURER, JOB_SUMMONER, JOB_AIR_ELEMENTALIST,
      JOB_VENOM_MAGE },
    { SK_UNARMED_COMBAT },
} },
...
{ SP_GARGOYLE, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_BERSERKER,
      JOB_PRIMALIST, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST,
      JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_HUMAN, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_CONJURER, JOB_NECROMANCER, JOB_PRIMALIST,
...
{ SP_MUMMY, {
    ...
    { JOB_WIZARD, JOB_CONJURER, JOB_NECROMANCER, JOB_PRIMALIST,
      JOB_ICE_ELEMENTALIST, JOB_FIRE_ELEMENTALIST, JOB_SUMMONER },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
      SK_BOWS, SK_CROSSBOWS, SK_SLINGS },
} },
...
{ SP_NAGA, {
    ...
    {},
    { JOB_BERSERKER, JOB_TRANSMUTER, JOB_ENCHANTER, JOB_PRIMALIST,
      JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_WARPER, JOB_WIZARD,
      JOB_VENOM_MAGE },
...
{ SP_OCTOPODE, {
    ...
    { JOB_TRANSMUTER, JOB_WIZARD, JOB_CONJURER, JOB_ASSASSIN, JOB_PRIMALIST,
...
{ SP_PYROLITH, {
    ...
    { { MUT_COLD_VULNERABILITY, 2, 1 },
      ...
      { MUT_FAST, 1, 9 },
      { MUT_BIG_WINGS, 1, 10 },
      { MUT_NEGATIVE_ENERGY_RESISTANCE, 1, 10 },
      { MUT_REGENERATION, 1, 11 },
      { MUT_MANA_REGENERATION, 1, 11 },
      { MUT_HIGH_MAGIC, 1, 12 },
      { MUT_ROBUST, 1, 12 },
      { MUT_AUGMENTATION, 1, 14 },
      { MUT_FAST, 1, 16 },
      { MUT_MUTATION_RESISTANCE, 1, 16 },
      { MUT_COLD_VULNERABILITY, 1, 18 },
      { MUT_HEAT_RESISTANCE, 1, 18 },
      { MUT_HIGH_MAGIC, 1, 19 },
      { MUT_REGENERATION, 1, 21 },
      { MUT_AUGMENTATION, 1, 24 },
      { MUT_ROBUST, 1, 24 }, },
    { "You are composed entirely of tempered lava.",
      "Other elemental magics completely elude you.",
      "Your molten body glows in the dark, making stealth beyond difficult." },
...
{ SP_TENGU, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_WIZARD, JOB_CONJURER, JOB_SUMMONER, JOB_PRIMALIST,
...
{ SP_VAMPIRE, {
    ...
    {},
    {},
    { JOB_GLADIATOR, JOB_ASSASSIN, JOB_ENCHANTER, JOB_PRIMALIST,
      JOB_EARTH_ELEMENTALIST, JOB_NECROMANCER, JOB_ICE_ELEMENTALIST },
...
{ SP_VINE_STALKER, {
    ...
    { JOB_FIGHTER, JOB_ASSASSIN, JOB_BERSERKER, JOB_ENCHANTER, JOB_CONJURER,
      JOB_PRIMALIST, JOB_NECROMANCER, JOB_ICE_ELEMENTALIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
      SK_BOWS, SK_CROSSBOWS, SK_SLINGS },
} },
#if TAG_MAJOR_VERSION == 34
